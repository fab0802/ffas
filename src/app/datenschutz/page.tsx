    ...
    <>
      ...
      <Reveal>
        <LegalContent updated="Demo-Version">
          ...
          <h2>2. Grundsatz</h2>
          <p>
            Diese Website verarbeitet so wenige Personendaten wie möglich. Es
            gibt keine Kontaktformulare, keinen Login, keinen Newsletter und
          ...
          <p>
            Diese Website setzt keine Tracking- oder Marketing-Cookies und
            bindet keine Analyse- oder Werbedienste ein.
          </p>
          ...
          <p>
            Aus Gründen des Persönlichkeitsschutzes werden Fotos von
            Spielerinnen im Rahmen dieses Demo-Projekts durch grafische
            Platzhalter ersetzt. Reale Personenaufnahmen sind nicht Teil der
            veröffentlichten Demo-Version.
          </p>
          ...
          <p>
            ...
            Recht auf Auskunft, Berichtigung, Löschung sowie auf Information
            über die Bearbeitung ihrer Daten. Da es sich um ein
            nicht-kommerzielles Demo-Projekt ohne aktive Erhebung von
            Personendaten handelt, werden über die technisch notwendigen
            Hosting-Logs hinaus keine Daten bearbeitet.
          </p>

          <h2>9. Besucher:innen aus der EU und dem EWR</h2>
          <p>
            Für Personen mit Aufenthalt in der EU beziehungsweise im EWR kann
            zusätzlich die Datenschutz-Grundverordnung (DSGVO) anwendbar sein.
            Die oben beschriebenen Rechte gelten in diesem Fall sinngemäss.
          </p>
        </LegalContent>
      </Reveal>
    </>
