      ...
      <Reveal>
        <LegalContent note={null}>
          ...
          <p>
            ...
            nicht offizielle Umsetzung: Sie wurde unabhängig als
            Portfolio-Projekt gebaut und ist weder der offizielle Webauftritt
            der Kooperation noch von ihr oder den beteiligten Vereinen in
            Auftrag gegeben. Die Inhalte dienen der Demonstration und erheben
            keinen Anspruch auf Vollständigkeit oder Aktualität. Der offizielle
            Auftritt der Kooperation findet sich unter{" "}
            <a
          ...
          <p>
            ...
            JetBrains Mono) sind über next/font selbst gehostet, gehostet wird
            das Ganze auf Netlify.
          </p>
          <p>
            Spielplan- und Resultatdaten werden serverseitig aus den
            öffentlichen iCal-Feeds von football.ch gelesen und aufbereitet.
          </p>

          <h2>Gestaltung</h2>
          <p>
            Die visuelle Sprache orientiert sich an einem dunklen,
            redaktionellen Magazin-Look: ein tiefes Navy als Basis, Pink als
            Akzent, Cream für Text. Serif (Fraunces) für grosse Titel, Monospace
            für Eyebrows und Meta-Angaben.
          </p>
          ...
          <p>
            ...
            Projekt-Look. Das Bildmaterial in den News-Beiträgen ist
            KI-generiert.
          </p>
